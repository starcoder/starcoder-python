...
class CategoricalDecoder(PropertyDecoder):
    ...
    def __init__(self, property: CategoricalProperty, input_size: int, activation, **args: Any):
...
class NullDecoder(PropertyDecoder):
    ...
    def __init__(self, property: NumericProperty, input_size: int, activation, **args: Any) -> None:
...
class DistributionDecoder(NumericDecoder):
    ...
    def __init__(self, property: DistributionProperty, input_size: int, activation, **args: Any) -> None:
...
class AudioDecoder(PropertyDecoder):
    ...
    def __init__(self, property: DataProperty, input_size: int, activation, **args: Any) -> None:
...
class SequenceDecoder(PropertyDecoder):
    ...
    def __init__(self, property: SequenceProperty, input_size: int, activation, **args: Any) -> None:
